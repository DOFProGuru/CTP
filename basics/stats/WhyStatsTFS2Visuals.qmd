...
::: {.bigbold style="text-align: center;"}
Intro and Basics Part 2</br>The Full Story
:::
...
#
::: {.centered}
 </br></br></br></br></br>**Thanks for watching!** </br> *The Full Story* companion video is in the link in the upper left. The first of the  *How To* videos, *Basic Statistics by Hand*  is in the upper right. To learn more about Chemical and Thermal Processes, visit the website linked in the description to find additional previous and following videos in this series.
:::
