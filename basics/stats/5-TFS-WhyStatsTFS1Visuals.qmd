...
# When doing an experiment,<br/>what is a *mean*?

# Why does an experimental engineer need to know<br/>what a mean is?

# Do you personally know<br/>anyone who cares about<br/>the difference between<br/>a *population mean*<br/>and a *sample mean*?

# Do you know what the difference between a population mean<br/>and a sample mean is?

# For a set of data, can you explain the difference between<br/>an *error* and a *residual*?
