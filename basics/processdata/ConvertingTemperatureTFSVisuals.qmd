...
# How Keen Is Your Rank?</br>The Full Story{.bigbold90}
...
::: {.bigger .centered}
*How Keen Is Your Rank?* is an episode of the Degrees of Freedom Project, *The Full Story* videos on chemical and thermal principles with additional in-depth discussion. If you want the *Just The Facts* version without additional discussion, use the link in the description. Definitions and additional details can be found in the web-page link in the description as well.
:::
...
# What are the common units of temperature used in Chemical and Thermal Processing?
...
# What two common temperature scales are absolute scales, starting at absolute zero?

# What is the difference between the temperature of an object and a temperature interval?
...
2. The conversions between *temperatures* are different from the conversion of *temperature intervals*.
...
4. All of the *temperature-interval* conversions just require multiplication by 9/5, 5/9, or 1.
