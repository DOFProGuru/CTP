...
![](OvenThermometer.png){.absolute right=0% top=20% width=35%}

:::{style="font-size: 60px;"}
:::{.absolute top=65% left=70%}
Gmhofmann, [CC BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0), via Wikimedia Commons
:::
:::
...
![](LiquidCrystalTherm.png){.absolute right=0% top=10%}
...
![](Thermistor.png){.absolute right=0% top=15.5% width=30%}
...
![](K-TCouple_2.png){.absolute right=0% top=10% width=20%}
...
![](SS-TSensor.png){.absolute right=0% top=10% width=25%}
...
| Contact? | Contact |
| Environ: | Depends on packaging. Can be very<br/>rugged. |
| Uses: | Labs, Precision Industrial |
:::
:::

![](RTD.png){.absolute right=0% top=10% width=22.5%}
...
![](InfraredPyrometer.png){.absolute right=0% top=10% width=30%}
