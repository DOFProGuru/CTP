...
:::{.absolute top=0 left=0 .bigbold130}
...
4. The High Vacuum (HV) range is from $10^{-1}$ to $10^{-5}\ \mathrm{Pa}$, Ultrahigh Vacuum (UHV) from $10^{-5}$ to $10^{-10}\ \mathrm{Pa}$, and eXtremely High Vacuum (XHV) is $10^{-10}\ \mathrm{Pa}$ and below.
