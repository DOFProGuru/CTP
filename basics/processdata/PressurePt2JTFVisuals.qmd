---
title: "Under Pressure Part 2 </br>
        Just The Facts"
author: "DOFPro Team"
format: 
  revealjs:
    ...
    incremental: true
    theme: [serif, ../../gradient.scss, ../../fontsize.scss]
    css: ../../slidecss.css
---
## Under Pressure
...
:::{.fragment}
![](https://dofprobucket1.s3.us-east-2.amazonaws.com/processdata/PressureGaugeAbs.png){.absolute left="10%" top="20%" width="30%"}
:::

:::{.fragment}
:::{.absolute top="23%" left="31%"}
$\Delta P = P_1 - P_2 = P_\mathrm{absolute}=P_\mathrm{abs}$
:::
:::

:::{.fragment}
![](https://dofprobucket1.s3.us-east-2.amazonaws.com/processdata/PressureGaugeAtm.png){.absolute left="10%" top="45%" width="30%"}
:::

:::{.fragment}
:::{.absolute top="48%" left="31%"}
$\Delta P = P_1 - P_2 = P_\mathrm{atmosphere}=P_\mathrm{atm}$
:::
:::

:::{.fragment}
![](https://dofprobucket1.s3.us-east-2.amazonaws.com/processdata/PressureGaugeGau.png){.absolute left="10%" top="70%" width="30%"}
:::

:::{.fragment}
:::{.absolute top="73%" left="31%"}
...
:::{.fragment}
![](https://dofprobucket1.s3.us-east-2.amazonaws.com/processdata/TireForGauge.png){.absolute left="10%" top="35%" width="30%"}
:::
...
:::{.fragment}
![](https://dofprobucket1.s3.us-east-2.amazonaws.com/processdata/NWSBaro.png){.absolute top="55%" left="5%" width="50%"}
:::
...
:::{.fragment}
![](https://dofprobucket1.s3.us-east-2.amazonaws.com/processdata/BaroPressDiagram.png){.absolute top="60%" left="0%" width="90%"}
:::
...
![](https://dofprobucket1.s3.us-east-2.amazonaws.com/processdata/TireExample.png){.absolute top="10%" left="10%" width="80%"}
