...
:::{.fragment .absolute top=63.2% left=15.35%}
<div style="color: red;">$\bcancel{\ }$</div>
:::

:::{.fragment .absolute top=67% left=29.3%}
<div style="color: red;">$\bcancel{\ }$</div>
:::

:::{.fragment .absolute top=63% left=25.6%}
<div style="color: red;">$\bcancel{\ \ }$</div>
:::
...
:::{.fragment .absolute top=63.5% left=53.5%}
<div style="color: red;">$\bcancel{\ }$</div>
:::

:::{.fragment .absolute top=67% left=50.75%}
<div style="color: red;">$\bcancel{\ \ }$</div>
:::
...
:::{.fragment .absolute top=67% left=60.5%}
<div style="color: red;">$\bcancel{\ \ \ }$</div>
:::

:::{.fragment .absolute top=63% left=72.5%}
<div style="color: red;">$\bcancel{\ \ \ }$</div>
:::
