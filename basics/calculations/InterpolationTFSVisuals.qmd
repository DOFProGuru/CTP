...
# What do you do if you need a value from a data table that is between two table values?

# What is interpolation?

# Can you name any types of interpolation besides linear?
...
![](steamtable1d.png){.absolute top=5% left=15% height=100%}
