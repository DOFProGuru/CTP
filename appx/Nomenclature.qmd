...
This appendix lists the symbols used throughout the **DOFPro Chemical and Thermal Processes (CTP)** videos and website.

Where possible, the notation used in the videos has been kept consistent with common chemical engineering textbooks. The final four columns indicate notation used in several widely used references:

- **F & R** — Felder, Rousseau, and Bullard  
- **SVN** — Smith, Van Ness, Abbott, and Swihart  
- **Ç & B** — Çengel and Boles  
- **H & R** — Hill and Root  

These comparisons are included to help readers translate between different notational conventions found in the literature.

Because different disciplines use different conventions, some symbols may have **multiple meanings depending on context**. In those cases the meaning should be clear from the surrounding discussion.
...
- Superscripts  
- Diacritical marks
- Not yet determined or referenced symbols
...
These symbols are not yet referenced in the videos or web pages. One we get around to making the additional videos, these symbols will be moved to the body of the table.
