...
The General Balance Equation is the basis for all material, energy, entropy, and exergy balances. The mass and mole balance equations are restatements of the general balance equation applied to mass and moles respectively. Mass is conserved, moles in systems with chemical reactions are not. The general balance equation applied to energy is the 1^st^ Law of Thermodynamics. Applied to entropy, it is the 2^nd Law of Thermodynamics. Like mass and moles, energy is conserved while entropy is not. The General Balance Equation is applied to systems, and the form depends on whether the system is is open or closed, and steady-state or transient. The videos explain systems and the attendant definitions.

## How to Keep Your Balance

*How to Keep Your Balance* begins by using bathtub analogies to explain system definitions: open or closed, and steady-state or transient. It then introduces the General Balance Equation and defines each of the terms.

<iframe width="560" height="315" src="https://www.youtube.com/embed/-fjXc-Upxx4?si=XmAMd9UTPypNhQEd" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
[Visuals](KeepYourBalanceJTFVisuals.qmd)

## Speed Balancing

*Speed Balancing* continues with definitions for system terms such as PFD, recycle, bypass, purge, tie component, and overall balances. It then gives hints and suggestions for how to quickly and correctly solve your balance equations for your systems. It has a worked bathtub example.

<iframe width="560" height="315" src="https://www.youtube.com/embed/Pmp2IxgL9FM?si=JHoFbh4pVoRUparS" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
