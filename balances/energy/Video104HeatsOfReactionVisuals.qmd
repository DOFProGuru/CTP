...
truncation errors keep the results from being identical. The most current value for the enthalpy of formation of ethane from NIST is $–84. \pm0.4\ \mathrm{kJ/mol}$, which is just outside the value we calculated.
