...
:  Normal range of chemical composition for fly ash produced from different coal types(expressed as percent by weight).
...
:::{.absolute top=31% left=27%}
$T_\mathrm{in}$
:::

:::{.absolute top=41% left=49%}
$T_\mathrm{out} = T_\mathrm{af}$
:::

:::{.absolute top=49% left=15%}
$Q\text{ or }\dot{Q} = 0$
:::

:::{.absolute top=44% left=70%}
$H\text{ or }\dot{0} = 0$
:::
...
|Species |LFL/LEL in volume % |UFL/UEL in volume % |Flash Point |Autoignition temperature |
|--------|-------------------:|-------------------:|-----------:|------------------------:|
