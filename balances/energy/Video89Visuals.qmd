...
## Enthalpy (pronounced en-THAL-pee){.bigbold90}
...
:::{.fragment}
$$
\Delta U = U_\mathrm{final} - U_\mathrm{initial} = Q + W
$$
$$
\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ = Q - \int\limits_\mathrm{initial}^\mathrm{final} pdV = Q-P \int\limits_\mathrm{initial}^\mathrm{final} dV
$$
:::
:::{.fragment}
$$
...
:::{.fragment .absolute left=25% top=63%}
$$
\dot{W} =  \dot{W}_\mathrm{s} + \dot{W}_\mathrm{fl}
$$
:::
:::{.fragment .absolute left=23% top=75%}
$$
...
:::{.fragment}
</br>$\Delta$ means *final-initial* or *out-in*</br></br>
:::
...
:::
:::{.fragment}
Common State Variables: $H$, $T$, $U$, $V$, $m$, etc.</br></br>
:::
...
:::
:::{.fragment}
Common Path Variables: $Q$, $W$.</br></br>
:::
