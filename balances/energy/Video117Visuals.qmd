...
<center> $\Delta S_{\text{surroundings}} = - \sum_j \dfrac{Q_j}{T_{\sigma j}}$ </center>

<center> $\Delta S_{\text{surroundings}} = - \sum_j \dfrac{Q_j}{T_{\sigma j}} = S_G \geq 0$ </center>
...
<center> $\dfrac{d(m \hat{S})_{cv}}{dt} + \Delta (\dot{m} \hat{S})_{\text{fs}} + \dfrac{d S_{\text{surr}}}{dt} = \dot{S}_G \geq 0$ </center>

<br>

<center>or $\dfrac{d(n \hat{S})_{cv}}{dt} + \Delta (\dot{n} \hat{S})_{\text{fs}} + \dfrac{d S_{\text{surr}}}{dt} = \dot{S}_G \geq 0$ </center>
...
<center> $\dfrac{d S_{\text{surr}}}{dt} = - \sum_j \dfrac{Q_j}{T_{\sigma j}}$ <center>
...
<center> $\Delta (\dot{m} \hat{S})_{\text{fs}} + \dfrac{d S_{\text{surr}}}{dt} = \dot{S}_G \geq 0$ </center>

<br>

<center> or $\Delta (\dot{n} \hat{S})_{\text{fs}} + \dfrac{d S_{\text{surr}}}{dt} = \dot{S}_G \geq 0$ </center>
...
The *Calculating Changes in Entropy* video explained the methods we
have for calculating changes in entropy.
