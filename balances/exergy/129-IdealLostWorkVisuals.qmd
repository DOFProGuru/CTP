...
![](HeatExchanger.png){.absolute top=10% left=30% width=40%}

::: {.fragment .absolute top=52% left=32%}
$\dot{m}\Delta H = \dot{Q} + \dot{W}_s = 0$
:::

::: {.fragment .absolute top=62% left=39%}
$\dot{Q} = 0$
:::

::: {.fragment .absolute top=72% left=35.5%}
$\boxed{\dot{W}_s = 0}$
:::

::: {.absolute top=24% left=61%}
::: {style="font-size: 70px;"}
$\mathrm{EtOH}$
:::
:::

::: {.absolute top=30% left=61%}
::: {style="font-size: 70px;"}
$100\ ^\circ\mathrm{C}$
:::
:::

::: {.absolute top=38% left=55%}
::: {style="font-size: 70px;"}
$90\ ^\circ\mathrm{C}$
:::
:::

::: {.absolute top=30% left=33.5%}
::: {style="font-size: 70px;"}
$50\ ^\circ\mathrm{C}$
:::
:::

::: {.absolute top=15% left=46%}
::: {style="font-size: 70px;"}
$40\ ^\circ\mathrm{C}$
:::
:::

::: {.absolute top=15% left=39%}
::: {style="font-size: 70px;"}
$\mathrm{H_2O}$
:::
:::
...
![](RefrigeratorCooling.png){.absolute left=20%}
...
::: {.absolute top=13% left=25%}
::: {style="font-size: 70px;"}
$\mathrm{EtOH}$
:::
:::

::: {.absolute top=19% left=25%}
::: {style="font-size: 70px;"}
$100\ ^\circ\mathrm{C}$
:::
:::

::: {.absolute top=19% left=66%}
::: {style="font-size: 70px;"}
$50\ ^\circ\mathrm{C}$
:::
:::

::: {.absolute top=26% left=42%}
::: {style="font-size: 70px;"}
$|\dot{Q}_\mathrm{cold}|$
:::
:::
::: {.absolute top=70% left=44.5%}
::: {style="font-size: 70px;"}
$|\dot{Q}_\sigma|$
:::
:::
::: {.absolute top=46.5% left=30%}
::: {style="font-size: 70px;"}
$|\dot{W}_s|$
:::
:::
::: {.absolute top=91% left=44%}
::: {style="font-size: 70px;"}
Ambient, $T_\sigma$
:::
:::
...
![](CarnotCooling.png){.absolute left=5%}

::: {.fragment .absolute top=62% left=15%}
$\dot{W}_\text{total} = \dot{m}(\hat{Q} - T_\sigma \Delta \hat{S})$
:::
::: {.fragment .absolute top=65% left=25.5%}
$$= \dot{m} \left(\int_{100}^{50} C_p dT - T_\sigma \int_{100}^{50} \dfrac{C_p}{T} dT\right)$$
:::
::: {.fragment .absolute top=83% left=25.5%}
$= 100[-6722.36 - 300(-19.2917)]$
:::
::: {.fragment .absolute top=92% left=25.5%}
$= -93.49 \text{ kJ/s} = W_\text{max}$
:::

::: {.absolute top=9.5% left=5%}
::: {style="font-size: 70px;"}
$\mathrm{EtOH}$
:::
:::
...
:::
:::
::: {.absolute top=44% left=20%}
::: {style="font-size: 70px;"}
$|\delta\dot{Q}_\sigma|$
:::
:::
::: {.absolute top=28.5% left=24%}
::: {style="font-size: 70px;"}
$|\delta\dot{W}_s|$
:::
:::
...
::::{.columns}
:::{.fragment}
Thermodynamic efficiency, $\eta_t$  or $\eta_{\tiny \mathrm{II}}$<br/><br/>
:::

- For processes that produce work:  


  $\eta_t = \frac{\dot{W}_{s}}{\dot{W}_\mathrm{ideal}}$<br/><br/>
