...
# Alcohol and Water DO Mix!{.bigbold75}
...
## Variations with Temperature and Pressure{.bigbold85}
...
## Variations with Temperature and Pressure (cont.){.bigbold75}

::: {style="font-size: 110px;"}
::: {.fragment}
</br>Values for $\beta$ and $\kappa$ come from experimental data, websites, handbooks, and tables, and equations of state. A web search can prove to be quite fruitful.
<br/><br/>
:::
::: {.fragment}
...
## Density of Mixtures of Liquids and Solids{.bigbold85}
...
## Density of Mixtures of Liquids and Solids (cont.){.bigbold75}
