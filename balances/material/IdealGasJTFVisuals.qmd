...
# Ideal Gases EXPOSED:<br/>Are They Even Real?!!{.bigbold75}
...
:::{.fragment}
![](RefTempsIG.png){.absolute top="55%" left="50%" width="50%"}
![](RefPressIG.png){.absolute top="55%" left="0%" width="50%"}
:::
...
:::{.fragment}
For the common case of $T_\mathrm{S} = 0\ ^\circ \mathrm{C}$ and $P_\mathrm{S} = 101.325\ \mathrm{kPa}$:
</br>(Natural gas often uses $T_\mathrm{S} = 15\ ^\circ \mathrm{C}$)
:::
:::{.fragment}
...
:::{.fragment .absolute top=30% left=3%}
$$
...
:::{.fragment .absolute top=52% left=3%}
$$
...
:::
:::
:::{.fragment .absolute top=70% left=0% style="font-size: 80px;"}
or
$$
