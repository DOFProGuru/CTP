...
- Requires simultaneous solution of chemical-kinetic, mass-transfer, and heat-transfer equations
...
$$
r = k_f C_\mathrm{B}^n C_\mathrm{C}^m - k_r C_\mathrm{P}^p C_\mathrm{Q}^q
$$
...
reaction with respect to the reactants $\mathrm{B}$, $\mathrm{C}$, $\mathrm{P}$, and $\mathrm{Q}$. They are not
...
first order in $\mathrm{B}$, second order in $\mathrm{C}$ and overall third order. A reaction
