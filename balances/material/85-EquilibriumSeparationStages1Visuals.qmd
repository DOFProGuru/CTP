...
::: {.fragment .absolute top=20% left=45%}
$z_{\mathrm{A},k}=0.250$
:::

::: {.fragment .absolute top=30% left=12%}
$x_{\mathrm{A},k}^l=0.158$
:::

::: {.fragment .absolute top=30% left=58%}
...
::: {.fragment}
$p_6^* = 10^{4.00266 - \frac{1171.530}{T - 48.784}}$
:::
::: {.fragment}
$p_7^* = 10^{4.02832 - \frac{1268.636}{T - 56.199}}$
:::
::: {.fragment}
$p_8^* = 10^{4.04867 - \frac{1355.126}{T - 63.633}}$
</br></br>
:::
::: {.fragment}
$P_\mathrm{calc} = \frac{1}{\sum\limits_{i=1}^N \dfrac{y_i}{p_i^*}} = \frac{1}{\dfrac{y_{6,k}}{p_6^*}+\dfrac{y_{7,k}}{p_7^*}+\dfrac{y_{8,k}}{p_8^*}}$
:::
::: {.fragment}
$\ \ \ \ \ \ \ \ = \dfrac{1}{\dfrac{0.450}{p_6^*}+\dfrac{0.450}{p_7^*}+\dfrac{0.100}{p_8^*}}$
</br></br>
:::
::: {.fragment}
$x_{6,k} = \dfrac{y_{6,k}P}{p_6^*},\ \ \ \ x_{7,k} = \dfrac{y_{7,k}P}{p_7^*},\ \ \ \ x_{8,k} = 1 - (x_{6,k} +x_{7,k} )$
:::
...
:::{.fragment .absolute top=64% left=29%}
$(30.0\%,\ 40.0\%,\ 30.0\%)$
:::
