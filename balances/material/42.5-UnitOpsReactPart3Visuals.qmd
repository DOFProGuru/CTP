...
# When You Saw It, What Was<br/>the Extent of Your Reaction? Part 3{.bigbold75}
...
::: {.fragment}
We don't count the water as an undesired product because it uses none of the $\mathrm{C}$ in the propane, which is the only species that goes to our desired product.</br></br>
:::
::: {.fragment}
