...
4. If there is only one reactor (with possibly multiple reactions) in a process with recycle, the overall fractional conversion of is almost certainly much higher than the fractional conversion in the reactor.
