...
The molar flows and the mole fractions or compositions are identical to those in the version with @eq-1 and @eq-2. However, the stoichiometric coefficients and extents of reaction are different.As long as you set up a linearly independent balanced set of equations that uses all of the species, it doesn't matter what set you use. The flows and compositions will all come out the same.
:::
:::
